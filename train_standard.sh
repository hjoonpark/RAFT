...
clear
mkdir -p checkpoints
# python -u train.py --name raft-chairs --stage chairs --validation chairs --gpus 0 --num_steps 1000000 --batch_size 1 --lr 0.0004 --image_size 368 496 --wdecay 0.0001
python -u train.py --name raft-tseries2d --stage tseries2d --validation tseries2d --gpus 0 --num_steps 1000000 --batch_size 1 --lr 0.0004 --image_size 512 512 --wdecay 0.0001
